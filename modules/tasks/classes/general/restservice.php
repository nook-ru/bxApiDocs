	...
	public static function onRestServiceBuildDescription()
	{
		...
		$arFunctionsMap = array(
			CRestUtil::EVENTS => array(
				...
				// task comments 
				'OnTaskCommentAdd' => 		array('forum', 'OnAfterCommentAdd', array('CTaskCommentItem', 'onEventFilter')),
				'OnTaskCommentUpdate' => 	array('forum', 'OnAfterCommentUpdate', array('CTaskCommentItem', 'onEventFilter')),
			)
		);
