...
class CTasks
{
	...
	public static function getManifest()
	{
		...
		$arWritableTaskDataKeys = array(
			...
			'TIME_ESTIMATE', 'ALLOW_TIME_TRACKING', 'ADD_IN_REPORT', 'SITE_ID',
			'DECLINE_REASON', 'STATUS', 'MARK'
		);
		...
		if ($arReadableTaskDataKeys === null)
		{
			$arReadableTaskDataKeys = array_merge(
				...
				array(
					...
					'GUID', 'ZOMBIE', 'MARK', 'MULTITASK', 'FAVORITE',
			...
			$arFilterableTaskDataKeys = array_merge(
				...
				array(
					'ACCOMPLICE', 'AUDITOR', 'DOER', 'MEMBER', 'TAG', 'ONLY_ROOT_TASKS'
				)
			);

			$arReadableTaskDataKeys[] = 'TIME_SPENT_IN_LOGS';
			$arReadableTaskDataKeys[] = 'TAGS';

			$arReadableTaskDataKeys = array_unique($arReadableTaskDataKeys);
		}
